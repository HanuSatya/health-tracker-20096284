...
class HealthTrackerAPITest {
    ...
    private var validName = "XYZ";
    private var validEmail = "xyz@gmail.com";

    private val updatedName ="abs";
    ...
    inner class UpdateUsers {
        ...
        fun `updating a user when it exists, returns a 204 response`() {
            ...
            assertEquals(updatedName, updatedUser.full_name)
            assertEquals(updatedEmail, updatedUser.email_id)
