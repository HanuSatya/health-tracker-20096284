...
class JavalinConfig {
    ...
    private fun registerRoutes(app: Javalin){
        app.routes {
            ...
            // USER Analytics api
            post("/api/analytics", HealthTrackerAPI::addAnalytics)
            get("/api/analytics/table", HealthTrackerAPI::getTableDetails)
            get("/api/analytics", HealthTrackerAPI::getAnalytics)
